...
> **Not shipped.** There is no Signal channel adapter in the codebase. Only five channel adapters ship today: **slack, telegram, discord, whatsapp, imessage** (`packages/channel-adapter-*`). This brief is kept as a historical planning doc; see [`docs/MODULE-CATALOG-STATUS.md`](../MODULE-CATALOG-STATUS.md) for what actually ships.
