...
The catalog is the architectural shape of the system. Implementation status, in-flight work, and the v1.3 backlog live in [MODULE-CATALOG-STATUS.md](MODULE-CATALOG-STATUS.md). Per-module build briefs (one page each) live in [module-briefs/](module-briefs/README.md). Section-by-section history lives in [build-roadmap.md](../operations/build-roadmap.md).
...
|---|---|
| **[CLAUDE.md](https://github.com/crewhaus/factory/blob/main/CLAUDE.md)** | The three architectural pillars: (1) the compiler is the protagonist, (2) eval is active not passive, (3) security is a fabric not a perimeter. Each pillar codifies an invariant the project will not violate. |
...
- **Primary pillar:** [Pillar 1 — Compiler as protagonist](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-1--the-compiler-is-the-protagonist). Required re-read.
...
- **Recipes:** [01-cli-coding-agent](https://github.com/crewhaus/demos/blob/main/recipes/01-cli-coding-agent.md), [02-sequential-workflow](https://github.com/crewhaus/demos/blob/main/recipes/02-sequential-workflow.md), [05-stateful-graph](https://github.com/crewhaus/demos/blob/main/recipes/05-stateful-graph.md) — read one matching the closest existing shape.
...
- **Primary pillar:** [Pillar 3 — Security is a fabric](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-3--security-is-a-fabric-not-a-perimeter) if your tool ingests external content (MCP responses, web fetches, file reads, sub-agent output). Required re-read. If the tool is pure compute, focus on Pillar 1.
...
- **Recipes:** [28-sub-agents-and-task](https://github.com/crewhaus/demos/blob/main/recipes/28-sub-agents-and-task.md), [29-permissions-deep-dive](https://github.com/crewhaus/demos/blob/main/recipes/29-permissions-deep-dive.md), [30-sandboxed-code-execution](https://github.com/crewhaus/demos/blob/main/recipes/30-sandboxed-code-execution.md).
...
- **Primary pillar:** [Pillar 3 — Security is a fabric](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-3--security-is-a-fabric-not-a-perimeter). Required re-read. Inbound channel content is classified at `TrustOrigin: "channel"` before it reaches the model.
...
- **Recipes:** [03-slack-bot](https://github.com/crewhaus/demos/blob/main/recipes/03-slack-bot.md), [37-channel-telegram](https://github.com/crewhaus/demos/blob/main/recipes/37-channel-telegram.md), [38-channel-discord](https://github.com/crewhaus/demos/blob/main/recipes/38-channel-discord.md), [39-channel-whatsapp](https://github.com/crewhaus/demos/blob/main/recipes/39-channel-whatsapp.md), [40-channel-imessage](https://github.com/crewhaus/demos/blob/main/recipes/40-channel-imessage.md).
...
- **Primary pillar:** [Pillar 2 — Eval is active](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-2--eval-is-active-not-passive). Required re-read. Eval that produces only HTML reports is passive grading — fine for canary gates, but not what the system is *for*.
...
- **Recipes:** [12-eval-harness](https://github.com/crewhaus/demos/blob/main/recipes/12-eval-harness.md), [34-building-custom-graders](https://github.com/crewhaus/demos/blob/main/recipes/34-building-custom-graders.md), [42-active-optimization](https://github.com/crewhaus/demos/blob/main/recipes/42-active-optimization.md).
...
- **Primary pillar:** [Pillar 3 — Security is a fabric](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-3--security-is-a-fabric-not-a-perimeter). Required re-read. The complete inventory of boundary sites is in CLAUDE.md; if you've added a new site, register a `TrustOrigin` in `packages/boundary-classifier/src/origins.ts` and call `classifyBoundary` before content reaches a model call or a tool result.
...
- **Recipes:** [41-security-fabric](https://github.com/crewhaus/demos/blob/main/recipes/41-security-fabric.md), [29-permissions-deep-dive](https://github.com/crewhaus/demos/blob/main/recipes/29-permissions-deep-dive.md), [30-sandboxed-code-execution](https://github.com/crewhaus/demos/blob/main/recipes/30-sandboxed-code-execution.md), [22-compliance-and-audit](https://github.com/crewhaus/demos/blob/main/recipes/22-compliance-and-audit.md), [23-pii-redaction-and-encryption](https://github.com/crewhaus/demos/blob/main/recipes/23-pii-redaction-and-encryption.md).
...
- **Primary pillar:** [Pillar 1 — Compiler as protagonist](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-1--the-compiler-is-the-protagonist). Required re-read. The `model-router` prefix grammar (`claude-*` / `openai/*` / `gemini/*` / `bedrock/*` / `local/<model>@<url>`) is part of the spec contract.
...
- **Recipes:** [18-multi-provider-fallback](https://github.com/crewhaus/demos/blob/main/recipes/18-multi-provider-fallback.md), [32-local-models](https://github.com/crewhaus/demos/blob/main/recipes/32-local-models.md), [33-prompt-caching](https://github.com/crewhaus/demos/blob/main/recipes/33-prompt-caching.md).
...
- **Primary pillar:** [Pillar 1 — Compiler as protagonist](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-1--the-compiler-is-the-protagonist) — the crew target's `IrCrewV0` variant is the contract; emitter touches that, not raw spec.
...
- **Recipes:** [04-multi-agent-crew](https://github.com/crewhaus/demos/blob/main/recipes/04-multi-agent-crew.md), [28-sub-agents-and-task](https://github.com/crewhaus/demos/blob/main/recipes/28-sub-agents-and-task.md).
...
- **Recipes:** [06-rag-pipeline](https://github.com/crewhaus/demos/blob/main/recipes/06-rag-pipeline.md), [07-autonomous-research](https://github.com/crewhaus/demos/blob/main/recipes/07-autonomous-research.md).
...
- **Primary pillar:** [Pillar 3 — Security is a fabric](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-3--security-is-a-fabric-not-a-perimeter) (tenancy / audit) and [Pillar 1 — Compiler as protagonist](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-1--the-compiler-is-the-protagonist) (canary / migration patch the IR not the runtime). Required re-read of both.
...
- **Recipes:** [11-managed-multitenant](https://github.com/crewhaus/demos/blob/main/recipes/11-managed-multitenant.md), [21-deployment-and-canary](https://github.com/crewhaus/demos/blob/main/recipes/21-deployment-and-canary.md), [22-compliance-and-audit](https://github.com/crewhaus/demos/blob/main/recipes/22-compliance-and-audit.md), [24-docker-and-helm](https://github.com/crewhaus/demos/blob/main/recipes/24-docker-and-helm.md), [36-cloud-deploy](https://github.com/crewhaus/demos/blob/main/recipes/36-cloud-deploy.md), [27-federation](https://github.com/crewhaus/demos/blob/main/recipes/27-federation.md).
...
- **Primary pillar:** [Pillar 1 — Compiler as protagonist](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-1--the-compiler-is-the-protagonist) — Studio compiles + runs specs, IDE plugins schema-validate them. The spec is the user-facing contract; the IR is internal.
- **Layers:** F4 (studio / authoring UX), F5 (plugin SDK).
- **Entry-point packages:** [packages/studio-server](https://github.com/crewhaus/factory/tree/main/packages/studio-server), [packages/studio-ui](https://github.com/crewhaus/factory/tree/main/packages/studio-ui), [packages/trace-viewer](https://github.com/crewhaus/factory/tree/main/packages/trace-viewer), [packages/graph-visualizer](https://github.com/crewhaus/factory/tree/main/packages/graph-visualizer), [packages/wizard](https://github.com/crewhaus/factory/tree/main/packages/wizard), [packages/scaffold-templates](https://github.com/crewhaus/factory/tree/main/packages/scaffold-templates), [packages/plugin-sdk](https://github.com/crewhaus/factory/tree/main/packages/plugin-sdk), [packages/vscode-extension](https://github.com/crewhaus/factory/tree/main/packages/vscode-extension), [packages/jetbrains-plugin](https://github.com/crewhaus/factory/tree/main/packages/jetbrains-plugin), [packages/crewhaus-playground](https://github.com/crewhaus/factory/tree/main/packages/crewhaus-playground).
...
- **Recipes:** [25-vscode-and-jetbrains](https://github.com/crewhaus/demos/blob/main/recipes/25-vscode-and-jetbrains.md), [26-template-marketplace](https://github.com/crewhaus/demos/blob/main/recipes/26-template-marketplace.md), [35-studio-walkthrough](https://github.com/crewhaus/demos/blob/main/recipes/35-studio-walkthrough.md).
...
- **Primary pillar:** [Pillar 1 — Compiler as protagonist](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-1--the-compiler-is-the-protagonist) — `IrVoiceV0` carries VAD + barge-in + telephony slots no other variant uses.
...
- **Recipes:** [09-voice-agent](https://github.com/crewhaus/demos/blob/main/recipes/09-voice-agent.md).
...
- **Primary pillar:** [Pillar 3 — Security is a fabric](https://github.com/crewhaus/factory/blob/main/CLAUDE.md#pillar-3--security-is-a-fabric-not-a-perimeter) — every browser action is fail-closed under the permission engine; vision-grounded actions classify the model's bbox output as untrusted.
...
- **Recipes:** [10-browser-agent](https://github.com/crewhaus/demos/blob/main/recipes/10-browser-agent.md).
...
| **Pillar 2 — eval is active** | R15 (telemetry / eval), F-eval (optimizer / orchestrator / spec-patch — sub-layers under F2) | §16 (eval stack), §29 (eval depth), §38 (production graders), §46 (active IR-patch optimizer) | [42-active-optimization.md](https://github.com/crewhaus/demos/blob/main/recipes/42-active-optimization.md) |
| **Pillar 3 — security is a fabric** | R8 (permissions / policy / safety), R5 (MCP host — boundary site), R10 (sub-agent — boundary site), R13 (channels — boundary site), R6 (compaction — boundary site), R9 (skills — boundary site) | §7 (permissions), §9 (MCP), §11 (skills), §13 (sub-agents), §18 (safety floor primitive), §29 (compaction), §33 (channel breadth), §34 (federation) | [41-security-fabric.md](https://github.com/crewhaus/demos/blob/main/recipes/41-security-fabric.md) |
