...
| **`onchain`** | Event-triggered on-chain daemon — watches blocks/addresses and acts under a transaction policy (simulation + approval gates). | [walkthrough 47](https://github.com/crewhaus/demos/blob/main/walkthroughs/47-onchain-daemon-and-game.md) | [walkthroughs/47-onchain-daemon-and-game.md](https://github.com/crewhaus/demos/blob/main/walkthroughs/47-onchain-daemon-and-game.md)               |
| **`onchain-game`** | Perceive-act loop against a game contract: read state, pick a move, broadcast, await confirmation, repeat. | [walkthrough 47](https://github.com/crewhaus/demos/blob/main/walkthroughs/47-onchain-daemon-and-game.md) | [walkthroughs/47-onchain-daemon-and-game.md](https://github.com/crewhaus/demos/blob/main/walkthroughs/47-onchain-daemon-and-game.md)               |
